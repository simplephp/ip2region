...
/**
 * Author: simplephp <onlineservice@gmail.com>
 * Date: 2019/11/27
 * Time: 5:09 PM
 */

namespace Simplephp\Ip2region;
...
class Ip2Region
{
    ...
    public function btreeSearch($ip)
    {
         ...
         **/
        [$country,$regionCode, $province, $city, $operators] = explode('|', substr($data, 4));
        return [
    ...
    public function memorySearch($ip)
    {
         ...
         * 分别表示 城市ip,国家，区域，省份，城市，运营商
         **/
        [$country,$regionCode, $province, $city, $operators] = explode('|', substr($this->dbBinStr, $dataPtr + 4, $dataLen - 4));
        return [
